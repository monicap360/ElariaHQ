...
-- Seed: Royal Caribbean Symphony of the Seas (Miami) 2026 sailings (additive)
with sailings_data as (
  select *
  from (
    values
      ('Symphony Of The Seas', '2026-02-08'::date, 7, 'Western Caribbean', 'Western Caribbean ports', 2172.89),
      ('Symphony Of The Seas', '2026-02-15'::date, 7, 'Eastern Caribbean', 'Eastern Caribbean ports', 1905.42),
      ('Symphony Of The Seas', '2026-02-22'::date, 7, 'Western Caribbean', 'Western Caribbean ports', 1916.39),
      ('Symphony Of The Seas', '2026-03-01'::date, 7, 'Eastern Caribbean', 'Eastern Caribbean ports', 1214.92),
      ('Symphony Of The Seas', '2026-03-08'::date, 7, 'Western Caribbean', 'Western Caribbean ports', 1381.39),
      ('Symphony Of The Seas', '2026-03-15'::date, 7, 'Eastern Caribbean', 'Eastern Caribbean ports', 1611.92),
      ('Symphony Of The Seas', '2026-03-22'::date, 7, 'Western Caribbean', 'Western Caribbean ports', 1390.39),
      ('Symphony Of The Seas', '2026-03-29'::date, 7, 'Eastern Caribbean', 'Eastern Caribbean ports', 1229.92),
      ('Symphony Of The Seas', '2026-04-05'::date, 7, 'Western Caribbean', 'Western Caribbean ports', 1636.89),
      ('Symphony Of The Seas', '2026-04-12'::date, 7, 'Eastern Caribbean', 'Eastern Caribbean ports', 1331.92)
  ) as v(ship_name, depart_date, nights, itinerary_label, ports_summary, min_price)
)
insert into public.sailings (
  id,
...
with sailings_data as (
  ...
  from (
    values
      ('Mariner Of The Seas', '2026-01-29'::date, 4, 'Western Caribbean', 'Western Caribbean ports', null),
      ('Harmony Of The Seas', '2026-02-01'::date, 7, 'Western Caribbean', 'Western Caribbean ports', 746.17),
      ('Mariner Of The Seas', '2026-02-02'::date, 5, 'Western Caribbean', 'Western Caribbean ports', null),
      ('Mariner Of The Seas', '2026-02-07'::date, 9, 'Western Caribbean', 'Western Caribbean ports', 1668.59),
      ('Harmony Of The Seas', '2026-02-08'::date, 7, 'Western Caribbean', 'Western Caribbean ports', null),
      ('Harmony Of The Seas', '2026-02-15'::date, 7, 'Western Caribbean', 'Western Caribbean ports', 1271.67),
      ('Harmony Of The Seas', '2026-02-22'::date, 7, 'Western Caribbean', 'Western Caribbean ports', 1133.17),
      ('Harmony Of The Seas', '2026-03-01'::date, 7, 'Western Caribbean', 'Western Caribbean ports', 1216.67),
      ('Harmony Of The Seas', '2026-03-08'::date, 8, 'Western Caribbean', 'Western Caribbean ports', 2198.62),
      ('Harmony Of The Seas', '2026-03-16'::date, 16, 'Transatlantic', 'Transatlantic itinerary', 1365.19)
  ) as v(ship_name, depart_date, nights, itinerary_label, ports_summary, min_price)
)
insert into public.sailings (
  id,
