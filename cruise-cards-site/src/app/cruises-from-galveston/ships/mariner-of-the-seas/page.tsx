...
export const metadata = {
  title: "Mariner of the Seas Cruises from Galveston",
  description:
    "Explore Mariner of the Seas cruises departing from Galveston, including upcoming sail dates, itineraries, and onboard amenities.",
  robots: {
    index: true,
    follow: true,
  },
...
export default async function MarinerOfTheSeasPage() {
    ...
    return (
      <main className="mx-auto max-w-6xl px-6 py-10">
        <section>
          ...
          <h1 className="mt-2 text-3xl font-semibold">Mariner of the Seas</h1>
  ...
  const { data: sailings } = await supabase
    ...
    .eq("ship", "Royal Caribbean Mariner of the Seas")
    .eq("bookable", true)
    ...
    <main className="mx-auto max-w-6xl px-6 py-10">
      <section>
        ...
        <p className="mt-4 text-gray-600">
          Mariner of the Seas is a Royal Caribbean ship sailing from Galveston, offering modern onboard amenities and
              ...
              <tbody>
                {sailings.map((sailing) => (
                  <tr key={sailing.departure_date} className="border-b">
                    ...
                    <td className="py-3 pr-4">{formatDurationLabel("Royal Caribbean", sailing.nights)}</td>
