...
export const metadata = {
  title: "Carnival Dream Cruises from Galveston",
  description:
    "Explore Carnival Dream cruises departing from Galveston, including upcoming sail dates, itineraries, and onboard highlights.",
  robots: {
    index: true,
    follow: true,
  },
  ...
  return (
    <main className="mx-auto max-w-6xl px-6 py-10">
      <section>
        ...
        <h1 className="mt-2 text-3xl font-semibold">Carnival Dream</h1>
        <p className="mt-4 text-gray-600">
          Carnival Dream is one of Carnival’s larger ships sailing from Galveston, offering a wide range of dining,
          entertainment, and longer Caribbean itineraries.
        </p>
      </section>
