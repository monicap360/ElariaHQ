...
export const metadata = {
  title: "Disney Magic Cruises from Galveston",
  description:
    "Explore Disney Magic cruises departing from Galveston, including upcoming sail dates, itineraries, and family-focused onboard experiences.",
  robots: {
    index: true,
    follow: true,
  },
...
export default async function DisneyMagicPage() {
    ...
    return (
      <main className="mx-auto max-w-6xl px-6 py-10">
        <section>
          ...
          <h1 className="mt-2 text-3xl font-semibold">Disney Magic</h1>
    ...
    <main className="mx-auto max-w-6xl px-6 py-10">
      <section>
        ...
        <p className="mt-4 text-gray-600">
          Disney Magic offers a family-focused cruise experience with themed entertainment, kids’ clubs, and classic
          Disney service on select sailings from Galveston.
        </p>
      </section>
              ...
              <tbody>
                {sailings.map((sailing) => (
                  <tr key={sailing.departure_date} className="border-b">
                    ...
                    <td className="py-3 pr-4">{formatDurationLabel("Disney", sailing.nights)}</td>
