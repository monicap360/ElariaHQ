    ...
    <main className="mx-auto max-w-6xl px-6 py-10">
      <section className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
        ...
        <p className="mt-3 text-slate-600">
          Getting to the ship should feel easy, calm, and well-planned — not rushed or confusing.
        </p>
        <p className="mt-3 text-slate-600">
          ...
          navigating the port. There is no single “best” option for everyone — only the best option for you.
        </p>
      </section>
      ...
      <section className="mt-10 rounded-2xl border border-slate-200 bg-white p-6">
        ...
        <ul className="mt-2 grid gap-2 text-sm text-slate-600 sm:grid-cols-2">
          ...
          <li>Location matters — not all lots are equal</li>
        </ul>
        <p className="mt-3 text-sm text-slate-600">
      ...
      <section className="mt-10 rounded-2xl border border-slate-200 bg-white p-6">
        <h2 className="text-xl font-semibold text-slate-900">3) Park-and-ride (Houston side – I-10 East)</h2>
        <p className="mt-3 text-sm text-slate-600">
      ...
      <section className="mt-10 rounded-2xl border border-slate-200 bg-white p-6">
        ...
        <p className="mt-3 text-sm text-slate-600">
          ...
          instead of early and prepared. The goal isn&apos;t perfection — it&apos;s peace of mind.
        </p>
      </section>
      ...
      <section className="mt-10 rounded-2xl border border-slate-200 bg-white p-6">
        ...
        <p className="mt-3 text-sm text-slate-600">
          Parking and transportation are part of your cruise experience — even if they happen before you board. This
